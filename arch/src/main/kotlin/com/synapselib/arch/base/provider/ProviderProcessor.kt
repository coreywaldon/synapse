    ...
    private fun generateHiltModule(entries: List<ProviderEntry>, dependencies: Dependencies) {
        ...
        file.writer().use { w ->
            w.write(buildString {
                ...
                appendLine("import com.synapselib.arch.base.provider.ProviderRegistryContribution")
                ...
                appendLine()
                appendLine("/**")
                appendLine(" * Auto-generated Hilt module that contributes a [ProviderRegistryContribution]")
                appendLine(" * to the multibinding set. The `SynapseProviderAggregatorModule` (from the")
                appendLine(" * `arch-hilt` artifact) collects all contributions and merges them into a")
                appendLine(" * single [ProviderRegistry] singleton.")
                appendLine(" *")
                ...
                appendLine(" * ```kotlin")
                appendLine(" * @UninstallModules(SynapseProviderModule_$moduleName::class)")
                ...
                append("    fun provideContribution(")
                appendLine()
                ...
                appendLine("    ): ProviderRegistryContribution {")
                appendLine("        val registry = ProviderRegistry.Builder()")
                ...
                appendLine("            .build()")
                appendLine("        return ProviderRegistryContribution(registry)")
                appendLine("    }")
                appendLine("}")
            })
        }
